...
import com.example.mrchatbot.activity.ChatActivity;
...
public class RecentChatRecyclerAdapter extends FirestoreRecyclerAdapter<ChatroomModel, RecentChatRecyclerAdapter.ChatroomModelViewHolder> {
        ...
        FirebaseUtils.getOtherUserFromChatroom(model.getUserIDs())
                .get().addOnCompleteListener(task -> {
                    if(task.isSuccessful()){
                        ...
                        FirebaseUtils.getOtherProfilePicStorage(otherUserModel.getUserId()).getDownloadUrl()
    ...
    class ChatroomModelViewHolder extends RecyclerView.ViewHolder{
        ...
        public ChatroomModelViewHolder(@NonNull View itemView) {
            ...
            lastMessageText = itemView.findViewById(R.id.last_msg_txt);
            profilePic = itemView.findViewById(R.id.profile_pic_img_view);
            lastMessageTime = itemView.findViewById(R.id.last_msg_time_txt);
        }
    }
}
